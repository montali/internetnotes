...
\begin{itemize}
    ...
    \item $d_{prop}$, propagation delay: livello fisico del link, $l/v$ con $l$ lunghezza dell ink e $v$ velocità di propagazione nel mezzo 
\end{itemize}
